...
print(f"1. {item_1_name} - ${item_1_price:.2f}")
# TODO 5: print item 2 using item_2_name and item_2_price
print(f"2. {item_2_name} - ${item_2_price:.2f}")
# TODO 6: print item 3 using item_3_name and item_3_price
print(f"3. {item_3_name} - ${item_3_price:.2f}")
# TODO 7: print item 4 using item_4_name and item_4_price
print(f"4. {item_4_name} - ${item_4_price:.2f}")
# TODO 8: print a final line of 30 equals signs
print( "==============================")
$git add.
$git commit -m "worked on print menu"
$git push origen easy-edit-luke
$git status
